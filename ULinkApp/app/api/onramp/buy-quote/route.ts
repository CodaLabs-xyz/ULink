...
import { generateCDPJWT, getCDPCredentials, getOnrampApiBaseUrl } from "@/lib/cdp-auth";
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Get dynamic API base URL based on environment
    const ONRAMP_API_BASE_URL = getOnrampApiBaseUrl();
